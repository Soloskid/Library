    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link active" href="/admin/requests">Book Requests</a></li>
                <li class="nav-item">
...
<div class="page-header">
    <div class="container">
        <h1><i class="fas fa-list"></i> Book Requests</h1>
        <p class="mt-2" style="color:#ccc;">Manage and fulfill user book requests</p>
    </div>
</div>
